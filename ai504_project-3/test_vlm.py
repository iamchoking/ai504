...
def evaluate(logits_filename, json_file, img_path):
    ...
    print(f'{logits_filename[:-4]} - Perplexity: {round(perplexity,5)}')

if __name__ == "__main__":
    # evaluate("20241234.npy", "./instruct_tuning/instruct.json","./instruct_tuning/images/")
    # evaluate("20243406.npy", "./instruct_tuning/instruct.json","./instruct_tuning/images/")
    # evaluate("12171558.npy", "./instruct_tuning/instruct.json","./instruct_tuning/images/")
    # evaluate("12171537.npy", "./instruct_tuning/instruct.json","./instruct_tuning/images/")
    evaluate("20244512.npy", "./instruct_tuning/instruct.json","./instruct_tuning/images/")
